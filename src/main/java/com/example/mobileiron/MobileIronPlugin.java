 ...
 * @since AM 5.5.0
 */
public class MobileIronPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(MobileIronPlugin.currentVersion,
				Collections.singletonList(MobileIron.class));
	}
	...
	public String getPluginVersion() {
		return MobileIronPlugin.currentVersion;
	}
}
